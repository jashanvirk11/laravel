                  ...
                  <form method="POST" action="{{route('user.register')}}"  class="" id="signup" enctype="multipart/form-data">
                    ...
                    @endif
                      ...
                      <div class="mb-3">
                        ...
                        <!--    </div><a class="nav-link-style fs-ms" href="{{route('user.forgot.password')}}">Forgot password?</a>-->
                        <!--</div>-->
                    <button onclick="myFunction()" class="btn btn-primary d-block w-100" id="signup" type="submit">Sign up</button>
                    <script>
                      function myFunction() {
                        alert("Password has been Sent in Your Email Address");
                      }
                      </script>
