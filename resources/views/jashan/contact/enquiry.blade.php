      ...
      <section class="container position-relative zindex-5 pt-7" style="margin-top: -590px;">
        <div class="row pt-md-4 pt-lg-5 mt-3">
          <div class="col-lg-4 col-md-5 offset-lg-1">
            <h1 class="text-dark mb-3 pb-4 pt-sm-3">Contacts</h1>
            <div class="d-flex align-items-start mb-4"><i class="ai-map-pin h3 mb-0 text-dark"></i>
              <div class="ps-3">
                <p class="text-dark mb-2">Shop no 8, Opp Kiran Nursing Home, Ajmer Road, Madanganj-Kishangarh Dist Ajmer (Rajasthan) Pin 305801, India</p><a class="fancy-link text-dark fs-sm" href="#map" data-scroll>See on the map</a>
              </div>
            </div>
            <div class="d-flex align-items-start mb-4"><i class="ai-mail h3 mt-n1 mb-0 text-dark"></i>
              <div class="ps-3"><a class="d-inline-block text-dark text-decoration-none mb-2" href="mailto:Care@ruralpure.com">Care@ruralpure.com</a></div>
            </div>
            <div class="d-flex align-items-start mb-4"><i class="ai-phone h3 mt-n1 mb-0 text-dark"></i>
              <div class="ps-3"><a class="d-inline-block text-dark text-decoration-none mb-2" href="tel:+919582066729">+91 9582066729, +91 7683055792</a></div>
            </div>
          </div>
              ...
              <div class="card-body py-5 px-3 px-sm-4">
                ...
                <form class="needs-validation pt-2 px-md-3" action="{{ route('submit.enquiry') }}" method="POST" novalidate>
                  ...
                  <div class="mb-3 pb-1">
                    ...
                    <textarea class="form-control" id="cont-message" rows="5" placeholder="Write your message here" name="message" required></textarea>
