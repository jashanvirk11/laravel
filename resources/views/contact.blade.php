      ...
      <section class="container position-relative zindex-5 pt-7" style="margin-top: -590px;">
        <div class="row pt-md-4 pt-lg-5 mt-3">
          <div class="col-lg-4 col-md-5 offset-lg-1">
            <h1 class="text-dark mb-3 pb-4 pt-sm-3">Contact Us</h1>
            ...
            <div class="d-flex align-items-start mb-4"><i class="ai-mail h3 mt-n1 mb-0 text-dark"></i>
              <div class="ps-3"><a class="d-inline-block text-dark text-decoration-none mb-2" href="mailto:Info@uniqueproducts.ca">Info@uniqueproducts.ca</a></div>
            </div>
            <div class="d-flex align-items-start mb-4"><i class="ai-phone h3 mt-n1 mb-0 text-dark"></i>
              <div class="ps-3"><a class="d-inline-block text-dark text-decoration-none mb-2"   href="tel:+16475475134">+16475475134</a></div>
            </div>
          </div>
          <div class="col-xl-6 col-md-7">
            <div class="card border-0 shadow-lg">
              <div class="card-body py-5 px-3 px-sm-4">
                ...
                <p class="fs-sm text-muted text-center">We normally respond within hour .</p>
