        ...
        <div class="row">
          ...
          @if(!$products->isEmpty())
            ...
            <div class="card card-product card-hover">
                <a class="card-img-top" href=""><img src="{{asset('uploads')}}/{{ $product->cover_photo }}" alt="Product thumbnail"></a>
              <div class="card-body"><a class="meta-link fs-xs mb-1" href="#"></a>
                <h3 class="fs-md fw-medium mb-2"><a class="meta-link" href="">{{ $product->name }}</a></h3><span class="text-heading fw-semibold">$ {{ $product->price }}</span>
              </div>
