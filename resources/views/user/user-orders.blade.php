                    ...
                    <h2 class="accordion-header" id="order-header-2">
                      <button class="accordion-button collapsed accordion-button no-indicator d-flex flex-wrap align-items-center justify-content-between pe-4" type="button" data-bs-toggle="collapse" data-bs-target="#order-collapse-2-{{$order->id}}" aria-expanded="false" aria-controls="order-collapse-2-{{$order->id}}">
                        ...
                        <div class="col-lg-2 col-sm-12 col-md-6">
                         <div class="col-3"></div>
                        <div class="col-9 text-body  fs-sm fw-medium">${{$order->total}}</div>
                        </div>
                      </button>
                    </h2>
                      ...
                      <div class="accordion-body pt-4 bg-secondary rounded-top-0 rounded-3">
                        ...
                        <div class="d-sm-flex justify-content-between mb-3 pb-1">
                          ...
                          <div class="fs-sm text-center pt-2">
                            ...
                            <div class="fw-medium">${{$orderitem->total_price}}</div>
                          </div>
                        </div>
                         @endforeach
                        <div class="d-flex flex-wrap align-items-center justify-content-between pt-3 border-top">
                          <div class="fs-sm my-2 me-2"><span class="text-muted me-1">Subtotal:</span><span class="fw-medium">${{$order->sub_total}}</span></div>
                          <div class="fs-sm my-2 me-2"><span class="text-muted me-1">Shipping:</span><span class="fw-medium">${{$order->shipping_charges}}</span></div>
                          <div class="fs-sm my-2 me-2"><span class="text-muted me-1">Tax:</span><span class="fw-medium">${{$order->gst}}</span></div>
                          <div class="fs-sm my-2"><span class="text-muted me-1">Total:</span><span class="fw-medium">${{$order->total}}</span></div>
                        </div>
                      </div>
                    </div>
                  </div>
